...
**Engine submodule:** [`openswmm.engine`](https://github.com/HydroCouple/openswmm.engine) (fork at `JoaquinAlvarado-py/openswmm.engine`)
...
13. [The Build System](#13-the-build-system)
14. [Scripts, Benchmarks & Verification](#14-scripts-benchmarks--verification)
15. [Server & CI/CD](#15-server--cicd)
16. [Development Workflow](#16-development-workflow)
17. [Troubleshooting](#17-troubleshooting)
18. [Known Gotchas & Oddities](#18-known-gotchas--oddities)
...
### 12.1 Project file (`.oswmm.json`)

The JSON produced by `Net.serialize()` (`network.js`) — a full snapshot of `{title, units, options, nodes, links, subcatchments, timeseries, curves, lidControls, lidUsages, pollutants, landUses, treatments, aquifers, snowpacks, snowpackAssignments, rawSections, …}`. This is what **Save** writes and **Load** reads.

### 12.2 INP dialect (standard SWMM)
