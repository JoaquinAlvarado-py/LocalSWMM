...
| Cuadrante | Responde | Léelo cuando |
|---|---|---|
...
- **¿Nuevo en LocalSWMM?** Parte por los [tutoriales](tutorials/) — enseñan haciendo.
- **¿Tienes una tarea específica?** Ve directo a las [guías de cómo hacer](how-to/).
- **¿Necesitas un dato?** Búscalo en la [referencia](reference/).
- **¿Quieres entender las matemáticas o la arquitectura?** Lee la [explicación](explanation/).

## Idiomas

- [Español](/es/) (primario para este sitio)
- [English](/) — English is the primary content language; Spanish mirrors it where translated.

## Fuentes

Los documentos fuente originales (LaTeX/HTML) desde los cuales se convirtió parte de esta documentación se conservan en [sources/](../sources/).

## Relacionados

- [README del repositorio](https://github.com/JoaquinAlvarado-py/LocalSWMM) — visión general del proyecto y inicio rápido
- [CONTEXT.md](https://github.com/JoaquinAlvarado-py/LocalSWMM/blob/experimental/CONTEXT.md) — glosario de dominio y terminología (Español)
